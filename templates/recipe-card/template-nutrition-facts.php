<?php
/**
 * Recipe-card/template-nutrition-facts.php
 *
 * This template can be overridden by copying it to yourtheme/yummy/recipe-card/template-nutrition-facts.php.
 *
...
<div class="yummy-nutrition-facts">
	<div class="yummy-nutrition-facts-header">
		<h3 class="yummy-big-card-subtitle"><?php esc_html_e( 'Nutrition Facts', 'yummy-recipes' ); ?></h3>
